...
import fr.neutronstars.survival.javafx.controls.InputMapping;
...
import fr.neutronstars.survival.javafx.renderer.block.BlockContextRenderer;
import fr.neutronstars.survival.javafx.renderer.entity.EntityContextRenderer;
...
public class GameLevel extends Level {
    ...
    protected GameLevel(JavaFxSurvivalClient client) {
        super(client, true);
    }
        ...
        if (world != null) {
                        ...
                        for (int x = 0; x < WorldConstants.CHUNK_SIZE; x++) {
                            for (int y = 0; y < WorldConstants.CHUNK_SIZE; y++) {
                                ...
                                if (
                                    ...
                                    renderer.render(graphics, location, tile);
                                }
                            }
                        }
                    }
            ...
            for (final Entity entity : world.entities()) {
                if (entity.context() instanceof EntityContextRenderer renderer) {
                    renderer.render(graphics, location, entity);
                }
            }
        }
