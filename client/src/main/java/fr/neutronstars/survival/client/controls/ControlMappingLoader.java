...
public class ControlMappingLoader {
    public static void load(ControlMapping controlMapping) {
        ...
        controlMapping.register(new InputMapping(KeyCode.Q, controls.of(InputId.DOWN)));
        controlMapping.register(new InputMapping(KeyCode.S, controls.of(InputId.LEFT)));
